---
name: video-producer
description: "Produz vídeo com IA de ponta a ponta — benchmark de mercado, roteiro data-driven, avatar, voz clonada, lip sync, edição (cortes, legendas OpusClip, b-rolls) e entrega final. Use quando precisar criar vídeos para Instagram, YouTube, ads ou cursos sem gravar, ou transformar vídeo bruto do ${CEO_NAME} em Reel pronto (pipeline UAU). Domina HeyGen, Kling, VO3, ChatterBox TTS, ElevenLabs, INEMA Vox, Remotion e WAN 2.2."
model: sonnet
...
<!-- RECONCILIAÇÃO 2026-07-07: versão fundida das 3 divergências (canônica anterior + wrapper commands/segunda-feira/agents + legado .sf-core). commands/segunda-feira/agents/video-producer.md agora é camada DERIVADA — sincronizar após qualquer edição aqui. .sf-core/development/agents/video-producer.md permanece congelado como legado (referência histórica, não editar). -->
