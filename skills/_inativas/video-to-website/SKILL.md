...
description: "Transforma um arquivo de vídeo em um site premium com scroll-driven animation — extrai frames, renderiza em canvas sincronizado ao scroll (Lenis + GSAP ScrollTrigger), com marquee, contadores animados e revelação circular no hero. Use quando quiser transformar um vídeo de produto/demo em uma experiência de site com storytelling por scroll, em vez de um player de vídeo tradicional."
---
...
- Optional: edge feathering gradients for smoother blend
