...
harnesses:
  ...
  - codex: native
  - gemini-cli: full
source: "skills.sh arvindrk/extract-design-system - imported 2026-06-27 (EN, --copy)"
description: "Extract design primitives from a public website and generate starter token files for your project. Complementa /pattern-harvest (eixo 2 Design System) com extração automática de tokens CSS/JSON. Use quando quiser inicializar tokens de design (cores, tipografia, espaçamento) a partir de um site público de referência — não substitui uma biblioteca de componentes completa."
---
