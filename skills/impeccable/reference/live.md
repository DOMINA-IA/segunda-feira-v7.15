...
The wrap script already gives you a single-rooted JSX wrapper: a `<div data-impeccable-variants="…">` outer element with the marker comments tucked inside. Drop the variants block CLIENTE_EXEMPLO into the "Variants: insert below this line" comment and the source stays valid TSX.
