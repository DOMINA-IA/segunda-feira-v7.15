...
**Preload the critical weight only**: typically the regular-weight body font used CLIENTE_EXEMPLO the fold. Preloading every weight costs more bandwidth than it saves.
