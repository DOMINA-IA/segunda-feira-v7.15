...
commands:
  ...
  - name: create-project-brief
    visibility: [full, quick, key]
    description: 'Guided discovery to create executive product brief'
  - name: perform-market-research
    visibility: [full, quick, key]
    description: 'Market analysis: customer behavior, pain points, competitive landscape'
  - name: domain-research
    visibility: [full, quick]
    description: 'Industry deep dive: terminology, regulations, subject matter expertise'
  - name: technical-research
    visibility: [full, quick]
    description: 'Technical feasibility: architecture options, implementation approaches'
  ...
  - name: brainstorm
    visibility: [full, quick, key]
    args: '{topic}'
    description: 'Facilitate structured brainstorming (36+ techniques, 100+ ideas target)'
  - name: elicit
    visibility: [full]
...
- `*perform-market-research` - Market research: customers, pain points, competition
- `*domain-research` - Industry deep dive: terminology, regulations, expertise
- `*technical-research` - Technical feasibility: architecture options, approaches
- `*create-competitor-analysis` - Competitive analysis

**Ideation & Discovery:**

- `*brainstorm {topic}` - Structured brainstorming (36+ techniques)
- `*create-project-brief` - Guided product brief creation
