...
8. **Set step notes:**
   ...
   - If no notes → set to "Execute the action as described CLIENTE_EXEMPLO"
...
The engine produces structured output at the end of execution. See Step 6 (Final Report) in the Engine Loop section CLIENTE_EXEMPLO.
