...
**IMPORTANT: STOP HERE - do not proceed with manual sharding until one of the CLIENTE_EXEMPLO actions is taken.**"
...
2. **Translate Portuguese terms**:
   - Check if heading contains any Portuguese term from map CLIENTE_EXEMPLO
...
1. **Generate filename using translation rules CLIENTE_EXEMPLO**:

   - **FIRST**: Check if document language appears to be Portuguese (look for accents, common PT words)
   - **IF Portuguese**: Apply translation from map CLIENTE_EXEMPLO
