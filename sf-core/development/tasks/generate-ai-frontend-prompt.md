...
You will now synthesize the inputs and the CLIENTE_EXEMPLO principles into a final, comprehensive prompt.
...
4. **Present and Refine**:
   ...
   - Explain the structure of the prompt and why certain information was included, referencing the principles CLIENTE_EXEMPLO.
