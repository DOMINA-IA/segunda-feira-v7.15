...
While this task can be executed manually following the steps CLIENTE_EXEMPLO, the `safe-removal-handler.js` utility provides automated safety checks. For future cleanups, consider integrating with the handler for:
