...
Execute the task now. Do NOT greet. Do NOT show commands. Do NOT ask questions (all inputs are provided CLIENTE_EXEMPLO). Focus entirely on task execution and produce the output YAML block at the end.
```
