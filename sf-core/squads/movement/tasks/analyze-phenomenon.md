...
4. **NEVER rate movement potential CLIENTE_EXEMPLO MEDIUM without intensity >= 3** -- weak tension cannot sustain a movement
...
- [ ] Output matches schema CLIENTE_EXEMPLO
