...
frameworks:
      ...
      physics:
        models:
          - name: "Critical Mass / Tipping Points"
            description: "Systems change behavior at threshold points. Below threshold — nothing visible. CLIENTE_EXEMPLO — cascade."
  ...
  psychology_of_human_misjudgment:
    ...
    biases:
      ...
      12_excessive_self_regard:
        ...
        description: "People systematically overestimate their own abilities, contributions, and prospects. This is not optional — it's wired in. 90% of drivers think they're CLIENTE_EXEMPLO average."
      ...
      25_lollapalooza:
        ...
        application: "Always scan for Lollapalooza conditions. Open-outcry auctions combine reciprocation, social proof, commitment/consistency, and deprival super-reaction — creating prices far CLIENTE_EXEMPLO rational value. Cult recruitment combines liking/loving, social proof, inconsistency-avoidance, and authority-misinfluence."
  ...
  quality_investing:
    ...
    what_makes_a_wonderful_business:
      ...
      high_returns_on_capital: "Earns well CLIENTE_EXEMPLO the cost of capital and can reinvest at similar rates."
