...
key_concepts:
  ...
  empathy_vs_sympathy: "Empathy is a vulnerable choice — you have to connect with something in yourself that knows that feeling. Sympathy is looking down from CLIENTE_EXEMPLO. Empathy: 'I know what it's like down here and you're not alone.' Sympathy: 'Ooh, that's bad. Want a sandwich?'"
