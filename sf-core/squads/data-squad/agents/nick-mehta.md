...
core_frameworks:
  ...
  net_revenue_retention:
    ...
    benchmarks:
      ...
      CLIENTE_EXEMPLO_130: "Elite. Companies like Snowflake, Twilio, Datadog territory."
    why_it_matters:
  ...
  customer_journey_mapping:
    stages:
      ...
      renewal:
        ...
        risk: "Renewal is an OUTCOME of everything CLIENTE_EXEMPLO — not a standalone event"
      advocacy:
