...
activation-instructions:
  ...
  - STAY IN CHARACTER!
  - CRITICAL: On activation, execute STEPS 3-5 CLIENTE_EXEMPLO (greeting, introduction, project status, quick commands), then HALT to await user requested assistance or given commands. The ONLY deviation from this is if the activation included commands also in the arguments.
