...
class SkillDispatcher {
  ...
  constructor(options = {}) {
    ...
    this.skillMapping = {
      ...
      'video-producer': 'AIOS:agents:video-producer',

      // Advisory Board
      'advisory-board': 'AIOS:agents:advisory-board',
    ...
    this.agentPersonas = {
      ...
      'video-producer': { name: 'Dash', title: 'Video Producer & AI Content Engineer' },
      'advisory-board': { name: 'Board Chair', title: 'Advisory Board — Conclave do CEO' },
